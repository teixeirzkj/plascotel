          ...
          return {
            items: [
              ...state.items,
              {
                ...
                estoqueDisponivel,
                peso: variante?.peso ?? product.peso,
                altura: variante?.altura ?? product.altura,
                largura: variante?.largura ?? product.largura,
                comprimento: variante?.comprimento ?? product.comprimento,
              },
            ],
            isOpen: true,
          };
